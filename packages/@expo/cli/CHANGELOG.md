...
- Add an `--expo-only` option to `expo install --check` and `expo install --fix` to only check or fix packages maintained by Expo. ([#1](https://github.com/expo/expo/pull/1) by [@matinzd](https://github.com/matinzd))
