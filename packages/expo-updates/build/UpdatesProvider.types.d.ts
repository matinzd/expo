 ...
 * Provided to application code from the [`useUpdates`](#useupdates) hook.
 */
export type DownloadAndRunUpdateType = () => Promise<void>;
/**
 ...
 */
export type DownloadUpdateType = (downloadHandler?: (event: UpdatesProviderDownloadEvent) => void) => void;
/**
 ...
 */
export type ReadLogEntriesType = (maxAge?: number) => void;
