...
import type { UpdatesInfo, CheckForUpdateType, DownloadUpdateType, DownloadAndRunUpdateType, RunUpdateType, ReadLogEntriesType } from './UpdatesProvider.types';
/**
...
declare const downloadAndRunUpdate: DownloadAndRunUpdateType;
declare const downloadUpdate: DownloadUpdateType;
declare const runUpdate: RunUpdateType;
/**
...
export type { UpdatesInfo, CurrentlyRunningInfo, AvailableUpdateInfo, UpdatesProviderDownloadEvent, CheckForUpdateType, DownloadUpdateType, DownloadAndRunUpdateType, RunUpdateType, ReadLogEntriesType, } from './UpdatesProvider.types';
